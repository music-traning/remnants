...
const missingJA = `
  ...
  gl_boss_item: "『俺が失う前の記憶』",
  gl_boss_item_origin: "全てを思い出した。俺が何者であり、何故この奈落へ落ちたのかを。全ステータスが劇的に上昇するが、凄まじい呪いが毎ターン命を削り続ける。",
  gl_boss_item_priest: "…まさか、これを本当に見つけるとはな。だが、お前が誰だったかを知って、どうなるというのだ……",
  gl_boss_drop: "『俺が失う前の記憶』を手に入れた……。",
  gl_boss_drop_full: "インベントリが満杯で『俺が失う前の記憶』を拾えなかった……！",
  
  gl_defeat: "{name} を討ち取った！（受けたダメージ: {dmg}, 獲得EXP: {exp}）",
  gl_unidentified_drop: "「未鑑定の記憶」を拾い、インベントリに収納した。",
  gl_inv_full_drop: "持ち物がいっぱいで記憶を拾えなかった…。",
  gl_curse_dmg: "【呪い】『俺が失う前の記憶』の強烈な負荷により、戦闘中に命が削られた！",
  ...
  gl_karma_items: "【業の強制取り立て】縁が不足している…。破戒僧が無理やり倉庫を探り、未装備の記憶を {count} 個没収した。",
  gl_karma_hp: "【業の強制取り立て】没収できる記憶が足りない。破戒僧はお前の肉体に呪いを刻み、最大HPを {penalty} 減少させた…",
  gl_karma_msg: "「対価もなしに帰れると思ったか？この世界は甘くないのだよ」",
...
const missingEN = `
  ...
  gl_karma_items: "[KARMA] Insufficient En. The corrupt priest forcibly searched your stash and confiscated {count} Unequipped Memories.",
